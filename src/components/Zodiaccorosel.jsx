...
const ZodiacCarousel = ({ autoScrollInterval = 4000 }) => {
    ...
    const nextSlide = () => {
        setCurrentIndex((prev) => (prev + 1) % zodiacSigns.length);
    };

    const prevSlide = () => {
        setCurrentIndex((prev) => (prev - 1 + zodiacSigns.length) % zodiacSigns.length);
    };
    ...
    const handleCardClick = (signName) => {
        navigate(`/horoscope/${signName.toLowerCase()}`);
    };
    ...
    return (
        <div className="relative w-full  py-16 md:py-20 overflow-hidden">
            ...
            {/* Glowing Orbs */}
            <div className="absolute top-20 left-10 w-40 h-40 bg-purple-600 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-float"></div>
            <div className="absolute bottom-20 right-10 w-40 h-40 bg-amber-500 rounded-full mix-blend-screen filter blur-3xl opacity-20 animate-float animation-delay-2s"></div>
            ...
            <div className="relative max-w-7xl mx-auto px-4">
                ...
                <div className="text-center mb-12 md:mb-16 space-y-4">
                    <div className="inline-flex items-center gap-3">
                        ...
                        <Sparkles className="text-amber-400 animate-pulse animation-delay-1s" size={24} />
                    </div>
                ...
                {/* Carousel - With proper container and grid */}
                <div
                    className="relative"
                ...
                >
                    ...
                    {/* Cards Container - Fixed grid layout */}
                            ...
                            {getVisibleCards().map((sign, idx) => (
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        className={`relative h-[520px] md:h-[540px] rounded-2xl overflow-hidden transition-all duration-500 cursor-pointer hover:shadow-2xl flex flex-col ${idx === 1
                                                ? 'hover:scale-105 shadow-xl'
                                                : 'hover:scale-100 opacity-90 hover:opacity-100'
                                            }`}
                                    >
                                        ...
                                        {/* Card Content */}
                                        <div className="relative h-full bg-gradient-to-br from-slate-800 to-slate-900 border-2 rounded-2xl overflow-hidden flex flex-col"
                                            style={{ borderColor: sign.color + '40' }}>

                                            {/* Top Section with Symbol */}
                                            <div className="relative h-48 bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center overflow-hidden">
                                                ...
                                                {/* Zodiac Symbol */}
                                                <div className="relative z-10 text-7xl md:text-8xl group-hover:scale-110 transition-transform duration-500"
                                            ...
                                            <div className="p-5 md:p-6 flex flex-col h-full">
                                                ...
                                                <div className="text-center space-y-2 mb-4">
                                                    <h3
                                                        className="text-2xl md:text-2xl font-serif font-bold"
                ...
                <div className="flex md:hidden justify-center gap-4 mt-8">
                    <button
                        onClick={prevSlide}
                        className="p-3 bg-slate-800/80 backdrop-blur-sm border border-amber-400/30 text-amber-400 rounded-full hover:bg-slate-700 hover:border-amber-400 transition-all"
                        aria-label="Previous"
                    >
                        <ChevronLeft size={20} />
                    </button>
...
const zodiacSigns = [
    {
        ...
        element: "Fire",
        color: "#FF6B6B",
        description: "Bold, ambitious, and confident. Aries are natural leaders who charge ahead with courage and determination.",
        traits: ["Courageous", "Passionate", "Leader"]
    },
    {
        name: "Taurus",
        symbol: "♉",
        ...
        element: "Earth",
        color: "#51CF66",
        description: "Reliable, patient, and devoted. Taurus values stability, comfort, and the finer things in life.",
    ...
    },
    {
        ...
        element: "Air",
        color: "#FFD43B",
        description: "Curious, adaptable, and communicative. Gemini thrives on variety and intellectual stimulation.",
        traits: ["Adaptable", "Curious", "Social"]
    },
    {
        name: "Cancer",
        symbol: "♋",
        ...
        element: "Water",
        color: "#74C0FC",
        description: "Intuitive, emotional, and protective. Cancer is deeply connected to home, family, and emotions.",
    ...
    },
    {
        ...
        element: "Fire",
        color: "#FFA94D",
        description: "Confident, creative, and generous. Leo shines brightly with natural charisma and warmth.",
    ...
    },
    {
        ...
        element: "Earth",
        color: "#8CE99A",
        description: "Analytical, practical, and meticulous. Virgo excels at organization and attention to detail.",
    ...
    },
    {
        ...
        element: "Air",
        color: "#FFB3C1",
        description: "Diplomatic, fair-minded, and social. Libra seeks harmony, beauty, and balanced relationships.",
    ...
    },
    {
        ...
        element: "Water",
        color: "#E599F7",
        description: "Intense, mysterious, and transformative. Scorpio possesses deep emotional strength and magnetism.",
        traits: ["Passionate", "Mysterious", "Loyal"]
    },
    {
        name: "Sagittarius",
        symbol: "♐",
        ...
        element: "Fire",
        color: "#FF9CAA",
        description: "Adventurous, optimistic, and philosophical. Sagittarius seeks truth, freedom, and new horizons.",
        traits: ["Optimistic", "Adventurous", "Free"]
    },
    {
        name: "Capricorn",
        symbol: "♑",
        ...
        element: "Earth",
        color: "#A78BFA",
        description: "Ambitious, disciplined, and responsible. Capricorn climbs toward success with determination.",
        traits: ["Ambitious", "Disciplined", "Wise"]
    },
    {
        name: "Aquarius",
        symbol: "♒",
        ...
        element: "Air",
        color: "#67E8F9",
        description: "Innovative, independent, and humanitarian. Aquarius envisions a better future for all.",
    ...
    },
    {
        ...
        element: "Water",
        color: "#C4B5FD",
        description: "Compassionate, artistic, and intuitive. Pisces flows with deep empathy and imagination.",
